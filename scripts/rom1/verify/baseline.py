...
HEADER = (
    ...
    "#              On first admission of a NEW function, unchanged below-MAX rows in\n"
    "#              that same TU are non-gating neighbor context: target partitioning\n"
    "#              moved, their source did not, and their historical MAX still holds.\n"
